...
public class BookingController extends HttpServlet {
    ...
    private void getVehicleListBySeat(HttpServletRequest request, HttpServletResponse response) throws IOException{
        ...
        try {
            ...
            List<Vehicle> vehicles = bookingService.getVehiclesBySeat(seatCount, startDate, endDate);
    ...
    private void addNewBooking(HttpServletRequest request, HttpServletResponse response) throws IOException, ParseException {
        ...
        try{
            Booking newBooking = new Booking(
                    ...
                    Integer.parseInt(request.getParameter("select_vehicle")),
                    0,
                    1,//from payment form
                    ...
                    2500.00,//from payment form
                    0
            );

            boolean isAdded= bookingService.addNewBooking(newBooking);
