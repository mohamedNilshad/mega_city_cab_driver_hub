<script>
    function getContent(){
        ...
        const invoiceCompanyInfo = getInvoiceCompanyInfo();
        const invoiceBookingInfo = getInvoiceBookingInfo();
        const invoiceBody = getInvoiceBody();
        const invoiceFooter = getInvoiceFooter();
        const stamp = getPaidStamp();
    ...
    function getInvoiceBookingInfo(){
        return `
            <div class="col-sm-6">
                <h6 class="mb-3">From:</h6>
                <div>
    ...
    function getPaidStamp(){
        return `<div class="rubber_stamp">Paid</div>`;
    }
