...
<html lang="en">
    ...
    <body id="page-top"  style="padding-top: 5px;">
        ...
        <a href="manage.jsp" class="btn btn-dark" style="margin-left: 5px;"><i class="zmdi zmdi-arrow-left"></i></a>

        <div style="padding-bottom: 5px; padding-right: 10px; float: right;"></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateDriverForm">
                            ...
                            <div class="mb-3">
                                <label for="nic" class="form-label">NIC  Number</label>
                                <input type="text" class="form-control" id="update_nic" name="update_driver_nic" placeholder="Enter your NIC">
                            </div>
